@echo off
echo ===================================================================
echo   Bet365 Pure CDP Auto-Refresh Daemon
echo   Target Sports: Big 5 Soccer, Tennis, Basketball, Handball,
echo                  Cycling, Golf, Formula 1
echo   Output: all_matches.json
echo ===================================================================
echo.
echo ETAPE 1 : Assurez-vous que Chrome est lance (start_chrome_cdp.bat)
echo ETAPE 2 : Ce daemon va mettre a jour all_matches.json toutes les 3 min
echo.
...
python auto_refresh.py --interval 180 --out all_matches.json
